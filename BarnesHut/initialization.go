...
func InitializeUniverse(galaxies []Galaxy, w float64) *Universe {
	...
	//range through the galaxies and put all the stars in the galaxies to the universe.
...
func InitializeJupiter() *Universe {
	...
	JUPITER.width = 4000000000

	var Jup, Io, Europa, Ganymede, Callisto Star
	jupiter := &Jup
	...
	callisto := &Callisto
	JUPITER.stars = []*Star{jupiter, io, europa, ganymede, callisto}
